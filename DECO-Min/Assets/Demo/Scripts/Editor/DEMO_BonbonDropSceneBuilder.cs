...
/// </summary>
public static class DEMO_BonbonDropSceneBuilder
{
    ...
    static void MakePlayer()
    {
        ...
        p.AddComponent<DEMO_PlayerController>();
        p.AddComponent<DEMO_StickerThrower>();
    }
    ...
    static void MakeCamera()
    {
        ...
        go.AddComponent<DEMO_CameraController>();
    ...
    {
        new GameObject("GameManager").AddComponent<DEMO_GameManager>();
        new GameObject("StickerBook").AddComponent<DEMO_StickerBook>();
    }
    ...
    static void MakeFieldObjects()
    {
        ...
        foreach (var d in defs)
        {
            ...
            var fo   = c.AddComponent<DEMO_FieldObject>();
    ...
    {
        new GameObject("GameUI").AddComponent<DEMO_GameUI>();
    }
    ...
    static void MakeBootstrap()
    {
        ...
        go.AddComponent<DEMO_SampleBootstrap>();
        go.AddComponent<DEMO_InputDiagnostic>(); // shows raw mouse state — remove when input is working
    }
