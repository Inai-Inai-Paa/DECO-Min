...
/// </summary>
public class DEMO_StickerThrower : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (sb  == null) sb  = DEMO_StickerBook.Instance ?? FindFirstObjectByType<DEMO_StickerBook>();
    ...
    private void DoAim()
    {
        ...
        foreach (var h in hits)
        {
            ...
            aimPt   = h.point;
            aimOnFO = h.collider.GetComponent<DEMO_FieldObject>() != null;
            break;
        }
    }
    ...
    private void Shoot()
    {
        ...
        if (go.TryGetComponent<DEMO_StickerProjectile>(out var proj))
    ...
    // ── Runtime sphere ────────────────────────────────────────────────────────
    private static GameObject CreateSphere(DEMO_StickerData d)
    {
        ...
        go.AddComponent<DEMO_StickerProjectile>();
        return go;
    }
