...
public static class MinimalSceneSetup
{
    ...
    private static GameObject CreatePlayer()
    {
        ...
        player.AddComponent<StickerThrower>();
    ...
    private static void CreateCamera(Transform playerTransform)
    {
        ...
        var ctrl = cam.GetComponent<CameraController>() ?? cam.AddComponent<CameraController>();
    ...
    private static void CreateManagers()
    {
        ...
        EnsureManager<StickerBook>("StickerBook");
    ...
    private static void CreateFieldObjects()
    {
        ...
        for (int i = 0; i < positions.Length; i++)
        {
            ...
            var fo = cube.AddComponent<FieldObject>();
    ...
    private static void CreateMinimalUI()
    {
        ...
        var hud      = hudPanel.AddComponent<ExplorationHUD>();
        ...
        var bookUI    = bookPanel.AddComponent<StickerBookUI>();
        ...
        // UIManager に参照を接続
        var uiSO = new SerializedObject(uiManagerGO.GetComponent<UIManager>());
