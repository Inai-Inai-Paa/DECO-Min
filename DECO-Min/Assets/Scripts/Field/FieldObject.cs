...
public class FieldObject : MonoBehaviour
{
    ...
    [SerializeField] private StickerData rewardStickerData;
    ...
    /// </summary>
    public void OnStickerApplied(StickerData sticker, GameObject visual)
    {
    ...
    private void TriggerStickerization()
    {
        ...
        var so = gameObject.AddComponent<StickerizedObject>();
    ...
    public void RuntimeSetup(StickerData reward, int count = 2)
    {
