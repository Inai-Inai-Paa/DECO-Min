...
public class PlayerController : MonoBehaviour
{
    ...
    private void Interact()
    {
        ...
        var dropped = FindObjectsByType<DroppedSticker>(FindObjectsSortMode.None);
        DroppedSticker nearestDrop = null;
        ...
        var all = FindObjectsByType<StickerizedObject>(FindObjectsSortMode.None);
        StickerizedObject best = null;
