...
public class StickerProjectile : MonoBehaviour
{
    ...
    /// </summary>
    public void Initialize(StickerData data, Vector3 origin, Vector3 target)
    {
        stickerData    = data;
        ...
        rb.linearVelocity = StickerThrower.CalcLaunchVelocity(
    ...
    private void Update()
    {
        ...
        foreach (var fo in FindObjectsByType<FieldObject>(FindObjectsSortMode.None))
        {
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        if (collision.gameObject.TryGetComponent<FieldObject>(out var fo))
        {
