...
public class GameUI : MonoBehaviour
{
    ...
    private void DrawInventory(StickerBook sb)
    {
    ...
    private void DrawPeelHint()
    {
        ...
        bool nearDrop = false;
        foreach (var ds in FindObjectsByType<DroppedSticker>(FindObjectsSortMode.None))
        {
        ...
        bool nearPeel = false;
        foreach (var so in FindObjectsByType<StickerizedObject>(FindObjectsSortMode.None))
        {
